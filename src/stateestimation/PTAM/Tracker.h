...
public:
  ...
  enum
  {
    I_FIRST, I_SECOND, I_FAILED, T_GOOD, T_DODGY, T_LOST, T_RECOVERED_GOOD, T_RECOVERED_DODGY, NOT_TRACKING,
    INITIALIZING, T_TOOK_KF
  } lastStepResult;
...
protected:
  ...
  enum
  {
    TRAIL_TRACKING_NOT_STARTED, TRAIL_TRACKING_STARTED, TRAIL_TRACKING_COMPLETE
